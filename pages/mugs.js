  ...
  return (
    ...
    <div className="container px-0 py-24 mx-auto">
      <div className="flex flex-wrap -m-4">
        <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-sm cursor-pointer">
          <Link  href="/product/ecommerce" className="block relative  rounded  cursor-pointer">
            <img
              ...
              src="https://rukminim1.flixcart.com/image/416/416/kv450280/mug/a/t/a/tom-jerry-cartoon-printed-coffee-and-tea-ceramic-11oz-gift-for-original-imag82wjgnsnjrmh.jpeg?q=70"
            />
          </Link>
          <div className="mt-4">
        ...
        <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-sm cursor-pointer">
          <Link href="/product/ecommerce" className="block relative  rounded  ">
            <img
              alt="ecommerce"
